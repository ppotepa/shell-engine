...
internal sealed class NetworkController
{
    ...
    /// <summary>Acquire called by <see cref="CognitosOs.Minix.Kernel.MinixSyscallGate"/> Debit.</summary>
    public void Acquire() => ReserveBandwidth();

    /// <summary>Release called by <see cref="CognitosOs.Minix.Kernel.MinixSyscallGate"/> Credit.</summary>
