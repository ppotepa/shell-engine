...
use super::{
    build_scene3d_frame_item_at, build_work_items, collect_scene3d_sources,
    load_and_resolve_scene3d, Scene3DAtlas, Scene3DRuntimeEntry, Scene3DWorkItem,
};
...
"#,
        ...
        let out = render_scene3d_frame_at_with(&entry, "orbit", 0, &asset_root, None, |item, _| {
...
"#,
        ...
        let out =
            render_scene3d_frame_at_with(&entry, "missing", 0, &asset_root, None, |_item, _| {
                Some(Buffer::new(1, 1))
            });
