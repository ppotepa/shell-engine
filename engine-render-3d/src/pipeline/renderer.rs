...
use crate::prerender::Scene3DWorkItem;
...
pub fn render_scene3d_work_item_canvas_with<F>(
...
pub fn render_scene3d_work_item_buffer_with<FV, FR, FB>(
    item: &Scene3DWorkItem,
    asset_root: &AssetRoot,
...
where
    ...
    FB: FnOnce(&mut Buffer, &Scene3DColorCanvas, u16, u16),
{
    ...
    let Some(canvas) =
        render_scene3d_work_item_canvas_with(item, asset_root, virtual_w, virtual_h, render_object)
    else {
        return Some(buf);
    };
